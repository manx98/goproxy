...
func (x *DirEntry) GetEntries() []*FileEntry {
	if x != nil {
		return x.Entries
	}
	return nil
...
var file_obj_proto_rawDesc = []byte{
	0x0a, 0x09, 0x6f, 0x62, 0x6a, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x40, 0x0a, 0x08, 0x44,
	0x69, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0c, 0x52, 0x02, 0x69, 0x64, 0x12, 0x24, 0x0a, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69,
	0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x5c, 0x0a,
	0x09, 0x46, 0x69, 0x6c, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x69, 0x73, 0x44, 0x69, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x6d, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x6d, 0x74, 0x69, 0x6d, 0x65, 0x42, 0x0a, 0x5a, 0x08, 0x2e,
	0x2f, 0x65, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_obj_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_obj_proto_goTypes = []any{
	(*DirEntry)(nil),  // 0: DirEntry
	(*FileEntry)(nil), // 1: FileEntry
}
var file_obj_proto_depIdxs = []int32{
	1, // 0: DirEntry.entries:type_name -> FileEntry
...
func file_obj_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_obj_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_obj_proto_msgTypes[1].Exporter = func(v any, i int) any {
